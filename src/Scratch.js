...
class Scratch extends Sprite {
	...
	uncaughtErrorHandler(event:UncaughtErrorEvent) {
	...
	log(severity, messageKey, extraData:Object = null):LogEntry {
	...
	logMessage(msg, extra_data:Object = null) {
	...
	viewedObj():ScratchObj {
		return viewedObject;
	}

	stageObj():ScratchStage {
		return stagePane;
	}
	...
	highlightSprites(sprites:Array) {
